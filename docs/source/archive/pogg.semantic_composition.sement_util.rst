...
Usage examples for the functions in this class can be found :doc:`here </pogg/semantic_composition/usage_nbs/sement_util_usage_with_output>`.
...
.. py:function:: find_var_eq_overlaps(gold_sement, actual_sement)
        ...
        .. list-table::
            ...
            * - Return Type
              - Description
            * - ``list``
              - list of overlapping semantic role identities
            * - ``list``
              - list of semantic role identities only present in the gold_sement
            * - ``list``
              - llist of semantic role identities only present in the actual_sement
...
.. py:function:: _build_overlap_eqs_table(overlap_eqs)
        ...
        .. list-table::
            ...
            * - ``overlap_eqs``
              - ``list``
              - list of semantic role identities present in two SEMENTs
        ...
        .. list-table::
            ...
            * - Return Type
              - Description
            * - ``str``
              - table representation of overlapping semantic role identities
...
.. py:function:: _build_nonoverlap_eqs_table(overlap_eqs, table_type)
        ...
        .. list-table::
            ...
            * - ``nonoverlap_eqs``
              - ``list``
              - list of semantic role identities present in one SEMENT
            * - ``table_type``
              - ``str``
              - type of table, either ``"gold"`` or ``"actual"``
        ...
        .. list-table::
            ...
            * - Return Type
              - Description
            * - ``str``
              - table representation of nonoverlapping semantic role identities
...
.. py:function:: build_isomorphism_report(gold_sement, actual_sement)
        ...
        Print a report detailing which semantic role identities and handle constraints are present in two SEMENTs. If two SEMENTs are not isomorphic, this can be used to pinpoint where the mismatch lies.
