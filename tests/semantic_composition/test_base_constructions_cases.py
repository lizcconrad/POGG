...
class SingleWordConstructions:
    ...
    FUNCTIONS BEING TESTED:
        - pogg.semantic_composition.base_constructions.SemanticComposition.basic
        - pogg.semantic_composition.base_constructions.SemanticComposition.adjective
        - pogg.semantic_composition.base_constructions.SemanticComposition.determiner
        - pogg.semantic_composition.base_constructions.SemanticComposition.named_entity
        - pogg.semantic_composition.base_constructions.SemanticComposition.noun
        - pogg.semantic_composition.base_constructions.SemanticComposition.preposition
        - pogg.semantic_composition.base_constructions.SemanticComposition.pronoun
        - pogg.semantic_composition.base_constructions.SemanticComposition.quantifier
        - pogg.semantic_composition.base_constructions.SemanticComposition.verb
...
class BaseConstructions:
    """
        FUNCTIONS BEING TESTED:
            - pogg.semantic_composition.base_constructions.SemanticComposition.prenominal_adjective
            - pogg.semantic_composition.base_constructions.SemanticComposition.compound_noun
            - pogg.semantic_composition.base_constructions.SemanticComposition.quantify
